...
def main(argv=None):
    ...
    p.add_argument("--limit", type=int, default=7, help="max axes when using --github")
    p.add_argument(
        "--exclude",
        default="html,css,shell,makefile,dockerfile,batchfile",
    ...
    p.add_argument("--no-animate", dest="animate", action="store_false", help="disable the grow-in animation")
